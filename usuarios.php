    ...
    <div class="container">
		...
		<div class="panel-heading">
		    <div class="btn-group pull-right">
				<button type='button' class="btn btn-info" data-toggle="modal" data-target="#myModal" title="Nuevo usuario"><span class="glyphicon glyphicon-plus" ></span></button>
			</div>
