    ...
    require_once("../libraries/password_compatibility_library.php");
		...
		if (empty($_POST['firstname'])){
			...
			require_once ("../config/conexion.php");//Contiene funcion que conecta a la base de datos
                ...
                $firstname = mysqli_real_escape_string($con,(strip_tags(utf8_decode($_POST["firstname"]),ENT_QUOTES)));
				$lastname = mysqli_real_escape_string($con,(strip_tags(utf8_decode($_POST["lastname"]),ENT_QUOTES)));
                ...
                $sql = "SELECT * FROM cert_users WHERE user_name = '" . $user_name . "' OR user_email = '" . $user_email . "';";
                ...
                if ($query_check_user == 1) {
                    ...
                    $sql = "INSERT INTO cert_users (firstname, lastname, user_name, user_password_hash, user_email, date_added)
