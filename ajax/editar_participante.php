<?php
	...
	if (empty($_POST['mod_id'])) {
           ...
           $errors[] = "Cédula vacío";
			...
			$errors[] = "Nombre de participante vacío";
		...
		$id_participa=$_POST['mod_id'];
		$sql="UPDATE cert_participa SET cedula='".$cedula."', nombres='".$nombres."', telefono='".$telefono."', correo='".$correo."' WHERE id_participa='".$id_participa."'";
		$query_update = mysqli_query($con,$sql);
			if ($query_update){
				$messages[] = "Datos del participantes han sido actualizado satisfactoriamente.";
			} else{
