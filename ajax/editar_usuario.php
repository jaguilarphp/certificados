		...
		if (empty($_POST['firstname2'])){
          ...
          )
         {
			...
			require_once ("../config/conexion.php");//Contiene funcion que conecta a la base de datos
                ...
                $firstname = mysqli_real_escape_string($con,(strip_tags(utf8_decode($_POST["firstname2"]),ENT_QUOTES)));
				$lastname = mysqli_real_escape_string($con,(strip_tags(utf8_decode($_POST["lastname2"]),ENT_QUOTES)));
