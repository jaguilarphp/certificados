...
<style type="text/css">
  ...
  <body>
	<!-- Modal -->
	<div class="modal fade" id="nuevoFormato" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			<form action="procesarformato.php" enctype="multipart/form-data" method="post" form class="form-horizontal">
